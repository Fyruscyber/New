...
const instagram = 'IndraFajru64'; // Nama Instagramlu cok
const nomer = 'https://Wa.me/+6285226087964_; // Nomor whatsapplu cok
const aktif = 'Ya Gk Tau'; // Kapan bot lu aktif
const groupwa = 'Coming Soon'; // OFFICIAL GRUP LU 1
